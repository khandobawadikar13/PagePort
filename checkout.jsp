...
<body style="background-color: #f0f1f2;">
					...
					<div class="card-body">
						...
						<form action="order" method="post">
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									<label for="inputEmail4">Phone Number</label> <input
										name="phno" type="tel" pattern="[789][0-9]{9}" maxlength="10"class="form-control"
							...
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									<label for="inputPassword4">City</label> <select type="text" 
    ...
    <option value="4">Chikamagalur</option>
    <option value="5">Mandya</option>
    </select>
								</div>
							</div>
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									<label for="inputEmail4" >State</label> <input type="text" value="Karnataka"
										name="state" class="form-control" id="inputEmail4" readonly required>
								</div>
								<div class="form-group col-md-6">
									<label for="inputPassword4">Pin code</label> <input type="text" 
										name="pincode" class="form-control" id="inputPassword4" maxlength="6" required>
								</div>
							</div>
